              ...
              <div className="col-md-8 d-flex align-items-center">
                <div className="card-body">
                  ...
                  >
                    ...
                    DevepHotel, un refugio rural que combina la rica tradición
                    de Asturias con la innovación del mundo digital. Roxana,
                    ...
                    belleza de Asturias, al tiempo que exploran las maravillas
                    del desarrollo web. Cada uno aportó sus habilidades únicas y
                    su amor inquebrantable por la región, fusionando la
                    tradición con la modernidad y creando un rincón especial:
                    DevepHotel.
                  </p>
                </div>
              </div>
            ...
            <div className="row g-0">
              <div className="col-md-8 d-flex align-items-center">
                <div className="card-body">
                  ...
                  >
                    Roxana, la visionaria, trajo consigo las costumbres y
                    sabores de generaciones pasadas, asegurándose de que cada
                    rincón del hotel resonara con la esencia de Asturias.
                    Franco, el intrépido, exploró las montañas para inspirar el
                    diseño del hotel y garantizar que cada ventana ofreciera
                    vistas impresionantes de los paisajes que amaba.
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-8 d-flex align-items-center">
                <div className="card-body">
                  ...
                  >
                    ...
                    obra maestra que contaba la historia de Asturias con colores
                    y formas. Su creatividad fluía en cada habitación, dando
                    vida a la riqueza cultural de la región. Mientras tanto,
                    Laura, la historiadora y cuentacuentos, recopiló las
                    historias locales y tradiciones, compartiéndolas con los
                    huéspedes en cenas alrededor de la chimenea.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-md-8 d-flex align-items-center">
                <div className="card-body mb-4">
                  ...
                  >
                    ...
                    tejido de amistad y pasión por Asturias, los visitantes
                    pueden no solo disfrutar de la naturaleza circundante, sino
                    también sumergirse en el mundo del desarrollo web, llevando
                    a cabo reuniones y conferencias que reflejan la esencia
                    tecnológica que impulsa a los fundadores de DevepHotel.
                  </p>
                </div>
              </div>
